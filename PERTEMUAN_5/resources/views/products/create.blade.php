...
@section('page-subtitle', 'Isi form di bawah untuk menambah produk ke inventaris')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100">
                ...
                <div>
                    <h2 class="font-semibold text-gray-900">Form Tambah Produk</h2>
                    <p class="text-xs text-gray-400">Kolom bertanda * wajib diisi</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Mie Goreng Instan"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="sku" value="{{ old('sku') }}" placeholder="Contoh: AB-1234"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" placeholder="Deskripsi singkat produk..."
                        class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent">{{ old('description') }}</textarea>
                </div>
